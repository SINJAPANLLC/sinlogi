      ...
      <div className="prose max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-4">
            本利用規約（以下「本規約」）は、SINJAPAN LOGI株式会社（以下「当社」）が提供する
            SINJAPAN LOGIサービス（以下「本サービス」）の利用条件を定めるものです。
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">第7条（退会）</h2>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">第8条（保証の否認および免責事項）</h2>
          <p className="text-gray-700 mb-4">
